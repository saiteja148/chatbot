...
import random
import tensorflow as tf  # Import TensorFlow to use legacy SGD optimizer

words = []
classes = []
documents = []
ignore_words = ['?', '!']
data_file = open(r"C:\Users\C KRISHNA\Desktop\intents.json").read()
...
# Extract the bag-of-words and labels from the training data
